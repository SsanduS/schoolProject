CREATE OR REPLACE FUNCTION school.timelesson_get(_class_id SMALLINT, _day_id SMALLINT, _lessonnumber SMALLINT,
                                                 _subject_id SMALLINT, _cabinet_id SMALLINT, _teacher_id SMALLINT,
                                                 _dt DATE) RETURNS JSONB
    SECURITY DEFINER
    LANGUAGE plpgsql
AS
$$
